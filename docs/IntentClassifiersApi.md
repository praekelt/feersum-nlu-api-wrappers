...
> list[LabelledTextSample] intent_classifier_add_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Add testing samples.
    api_response = api_instance.intent_classifier_add_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
...
> list[LabelledTextSample] intent_classifier_add_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Add training samples.
    api_response = api_instance.intent_classifier_add_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> IntentClassifierInstanceDetail intent_classifier_create(create_details, x_caller=x_caller, origin=origin)
...
try:
    # Create an intent classifier.
    api_response = api_instance.intent_classifier_create(create_details, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_curate(instance_name, label_pair, x_caller=x_caller, origin=origin)
...
try:
    # Endpoint to aid in the curation of a model instance.
    api_response = api_instance.intent_classifier_curate(instance_name, label_pair, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> IntentClassifierInstanceDetail intent_classifier_del(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete named instance.
    api_response = api_instance.intent_classifier_del(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_del_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Delete testing samples.
    api_response = api_instance.intent_classifier_del_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_del_testing_samples_all(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete all testing samples.
    api_response = api_instance.intent_classifier_del_testing_samples_all(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_del_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Delete training samples.
    api_response = api_instance.intent_classifier_del_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_del_training_samples_all(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete all training samples.
    api_response = api_instance.intent_classifier_del_training_samples_all(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> IntentClassifierInstanceDetail intent_classifier_get_details(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get details of named instance.
    api_response = api_instance.intent_classifier_get_details(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[IntentClassifierInstanceDetail] intent_classifier_get_details_all(x_caller=x_caller, origin=origin)
...
try:
    # Get list of loaded intent classifiers.
    api_response = api_instance.intent_classifier_get_details_all(x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[ClassLabel] intent_classifier_get_labels(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get list of possible labels.
    api_response = api_instance.intent_classifier_get_labels(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> ModelParams intent_classifier_get_params(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get the editable model parameters of named intent classifier.
    api_response = api_instance.intent_classifier_get_params(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_get_testing_samples(instance_name, x_caller=x_caller, origin=origin, index=index, len=len)
...
try:
    # Get testing samples.
    api_response = api_instance.intent_classifier_get_testing_samples(instance_name, x_caller=x_caller, origin=origin, index=index, len=len)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_get_training_samples(instance_name, x_caller=x_caller, origin=origin, index=index, len=len)
...
try:
    # Get training samples.
    api_response = api_instance.intent_classifier_get_training_samples(instance_name, x_caller=x_caller, origin=origin, index=index, len=len)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_online_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Train/update the classifier online with the samples provided.
    api_response = api_instance.intent_classifier_online_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[ScoredLabel] intent_classifier_retrieve(instance_name, text_input, x_caller=x_caller, origin=origin)
...
try:
    # Classify intent.
    api_response = api_instance.intent_classifier_retrieve(instance_name, text_input, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> IntentClassifierInstanceDetail intent_classifier_set_params(instance_name, model_params, x_caller=x_caller, origin=origin)
...
try:
    # Set the model parameters of named intent classifier.
    api_response = api_instance.intent_classifier_set_params(instance_name, model_params, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> IntentClassifierInstanceDetail intent_classifier_train(instance_name, train_details, x_caller=x_caller, origin=origin)
...
try:
    # Train the named intent classifier.
    api_response = api_instance.intent_classifier_train(instance_name, train_details, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[TsneSample] intent_classifier_tsne_get(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get the latest results of TSNE.
    api_response = api_instance.intent_classifier_tsne_get(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> intent_classifier_tsne_post(instance_name, tsne_settings, x_caller=x_caller, origin=origin)
...
try:
    # Endpoint to start a TSNE process.
    api_instance.intent_classifier_tsne_post(instance_name, tsne_settings, x_caller=x_caller, origin=origin)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_update_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Update testning samples by UUID.
    api_response = api_instance.intent_classifier_update_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_update_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Update training samples by UUID.
    api_response = api_instance.intent_classifier_update_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> IntentClassifierInstanceDetail intent_classifier_vaporise(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Vaporise the named model.
    api_response = api_instance.intent_classifier_vaporise(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
