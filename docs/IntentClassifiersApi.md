...
> list[LabelledTextSample] intent_classifier_get_testing_samples(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get testing samples.
    api_response = api_instance.intent_classifier_get_testing_samples(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] intent_classifier_get_training_samples(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get training samples.
    api_response = api_instance.intent_classifier_get_training_samples(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
