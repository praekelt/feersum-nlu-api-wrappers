...
try:
    # Add testing samples.
    api_response = api_instance.text_classifier_add_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
...
try:
    # Add training samples.
    api_response = api_instance.text_classifier_add_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> TextClassifierInstanceDetail text_classifier_create(create_details, x_caller=x_caller, origin=origin)
...
try:
    # Create a text classifier.
    api_response = api_instance.text_classifier_create(create_details, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] text_classifier_curate(instance_name, label_pair, x_caller=x_caller, origin=origin)
...
try:
    # Endpoint to aid in the curation of a model instance.
    api_response = api_instance.text_classifier_curate(instance_name, label_pair, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
# **text_classifier_del**
> TextClassifierInstanceDetail text_classifier_del(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete named instance.
    api_response = api_instance.text_classifier_del(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] text_classifier_del_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Delete testing samples.
    api_response = api_instance.text_classifier_del_testing_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] text_classifier_del_testing_samples_all(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete testing samples.
    api_response = api_instance.text_classifier_del_testing_samples_all(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] text_classifier_del_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
...
try:
    # Delete training samples.
    api_response = api_instance.text_classifier_del_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[LabelledTextSample] text_classifier_del_training_samples_all(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete all training samples.
    api_response = api_instance.text_classifier_del_training_samples_all(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> TextClassifierInstanceDetail text_classifier_get_details(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get details of named instance.
    api_response = api_instance.text_classifier_get_details(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[TextClassifierInstanceDetail] text_classifier_get_details_all(x_caller=x_caller, origin=origin)
...
try:
    # Get list of loaded text classifiers.
    api_response = api_instance.text_classifier_get_details_all(x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[ClassLabel] text_classifier_get_labels(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get list of possible labels.
    api_response = api_instance.text_classifier_get_labels(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> ModelParams text_classifier_get_params(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get the editable model parameters of named text classifier.
    api_response = api_instance.text_classifier_get_params(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
try:
    # Train/update the classifier online with the samples provided.
    api_response = api_instance.text_classifier_online_training_samples(instance_name, labelled_text_sample_list, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[ScoredLabel] text_classifier_retrieve(instance_name, text_input, x_caller=x_caller, origin=origin)
...
try:
    # Classify text.
    api_response = api_instance.text_classifier_retrieve(instance_name, text_input, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> TextClassifierInstanceDetail text_classifier_set_params(instance_name, model_params, x_caller=x_caller, origin=origin)
...
try:
    # Set the model parameters of named text classifier.
    api_response = api_instance.text_classifier_set_params(instance_name, model_params, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> TextClassifierInstanceDetail text_classifier_train(instance_name, train_details, x_caller=x_caller, origin=origin)
...
try:
    # Train the named text classifier.
    api_response = api_instance.text_classifier_train(instance_name, train_details, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[TsneSample] text_classifier_tsne_get(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get the latest results of TSNE.
    api_response = api_instance.text_classifier_tsne_get(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> text_classifier_tsne_post(instance_name, tsne_settings, x_caller=x_caller, origin=origin)
...
try:
    # Endpoint to start a TSNE process.
    api_instance.text_classifier_tsne_post(instance_name, tsne_settings, x_caller=x_caller, origin=origin)
except ApiException as e:
...
> TextClassifierInstanceDetail text_classifier_vaporise(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Vaporise the named model.
    api_response = api_instance.text_classifier_vaporise(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
