...
> DucklingEntityExtractorInstanceDetail duckling_entity_extractor_create(create_details, x_caller=x_caller, origin=origin)
...
try:
    # Create a duckling entity extractor.
    api_response = api_instance.duckling_entity_extractor_create(create_details, x_caller=x_caller, origin=origin)
    pprint(api_response)
...
> DucklingEntityExtractorInstanceDetail duckling_entity_extractor_del(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Delete named instance.
    api_response = api_instance.duckling_entity_extractor_del(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> DucklingEntityExtractorInstanceDetail duckling_entity_extractor_get_details(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get details of named instance.
    api_response = api_instance.duckling_entity_extractor_get_details(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[DucklingEntityExtractorInstanceDetail] duckling_entity_extractor_get_details_all(x_caller=x_caller, origin=origin)
...
try:
    # Get list of loaded regular expression entity extractors.
    api_response = api_instance.duckling_entity_extractor_get_details_all(x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> ModelParams duckling_entity_extractor_get_params(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Get the editable model parameters of named duckling entity extractor.
    api_response = api_instance.duckling_entity_extractor_get_params(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> list[DucklingEntity] duckling_entity_extractor_retrieve(instance_name, text_input, x_caller=x_caller, origin=origin)
...
try:
    # Extract information based on the regular expression.
    api_response = api_instance.duckling_entity_extractor_retrieve(instance_name, text_input, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> DucklingEntityExtractorInstanceDetail duckling_entity_extractor_set_params(instance_name, model_params, x_caller=x_caller, origin=origin)
...
try:
    # Set the model parameters of named duckling entity extractor.
    api_response = api_instance.duckling_entity_extractor_set_params(instance_name, model_params, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
...
> DucklingEntityExtractorInstanceDetail duckling_entity_extractor_vaporise(instance_name, x_caller=x_caller, origin=origin)
...
try:
    # Vaporise the named model.
    api_response = api_instance.duckling_entity_extractor_vaporise(instance_name, x_caller=x_caller, origin=origin)
    pprint(api_response)
except ApiException as e:
