# TextDatasetInstanceDetail

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**name** | **str** | The sluggy-url-friendly-name of the instance. | 
**id** | **str** | The unique id of a specific version of the dataset instance. | 
...
**readonly** | **bool** | Indicates if the dataset is readonly and not editable. | [optional] 
