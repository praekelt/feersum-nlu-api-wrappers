...
> ModelParams regex_entity_extractor_get_params(instance_name)
...
> list[RegexEntity] regex_entity_extractor_retrieve(instance_name, text_input)
...
> RegexEntityExtractorInstanceDetail regex_entity_extractor_vaporise(instance_name)
