...
[**person_name_entity_extractor_get_details_all**](PersonNameEntityExtractorsApi.md#person_name_entity_extractor_get_details_all) | **GET** /nlu/v2/person_name_entity_extractors | Get list of regular expression entity extractors.
...
Get the list of person_name entity extractors.
