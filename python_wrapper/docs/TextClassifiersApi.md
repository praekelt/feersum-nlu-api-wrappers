...
> TotalSamples text_classifier_add_training_samples(instance_name, labelled_text_samples)
...
labelled_text_samples = feersum_nlu.LabelledTextSamples() # LabelledTextSamples | List of labelled text samples.
 ...
 **labelled_text_samples** | [**LabelledTextSamples**](LabelledTextSamples.md)| List of labelled text samples. | 
...
> LabelledTextSamples text_classifier_del_training_samples(instance_name)
...
[**LabelledTextSamples**](LabelledTextSamples.md)
...
> LabelledTextSamples text_classifier_get_training_samples(instance_name)
