...
class InstanceDetail(object):
    ...
    def __init__(self, name=None, id=None, desc=None, training_accuracy=None, training_f1=None, training_stamp=None, training_cm=None, cm_labels=None, word_manifold_list=None, threshold=None):  # noqa: E501
