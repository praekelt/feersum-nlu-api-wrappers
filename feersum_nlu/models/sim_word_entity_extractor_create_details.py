...
class SimWordEntityExtractorCreateDetails(object):
    ...
    def __init__(self, name=None, long_name=None, desc=None, similar_words=None, threshold=None, word_manifold=None, load_from_store=None, revision_uuid=None):  # noqa: E501
    ...
    def revision_uuid(self):
        """Gets the revision_uuid of this SimWordEntityExtractorCreateDetails.  # noqa: E501

        If provided, the uuid of the revision of the model to try and load from the model history.  # noqa: E501

        :return: The revision_uuid of this SimWordEntityExtractorCreateDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def revision_uuid(self, revision_uuid):
        """Sets the revision_uuid of this SimWordEntityExtractorCreateDetails.

        If provided, the uuid of the revision of the model to try and load from the model history.  # noqa: E501

        :param revision_uuid: The revision_uuid of this SimWordEntityExtractorCreateDetails.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SimWordEntityExtractorCreateDetails, dict):
