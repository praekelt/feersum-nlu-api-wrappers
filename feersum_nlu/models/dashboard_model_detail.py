...
class DashboardModelDetail(object):
    ...
    def uuid(self):
        ...
        A universally unique ID used to reference this revision of the instance.  # noqa: E501
    ...
    def has_labels(self):
        ...
        Whether or not the model returns a list of scored labels. Unknown if flag not present.  # noqa: E501
    ...
    def trashed(self):
        ...
        Whether or not this model has been deleted. Deleted models can be reloaded using the create opeeration.  # noqa: E501
