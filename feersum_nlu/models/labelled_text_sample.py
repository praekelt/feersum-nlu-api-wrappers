...
class LabelledTextSample(object):
    ...
    def __init__(self, text=None, label=None, lang_code=None, comment=None, uuid=None, suggested_labels=None):  # noqa: E501
    ...
    def suggested_labels(self):
        """Gets the suggested_labels of this LabelledTextSample.  # noqa: E501

        The label suggested for the sample using the active learner  # noqa: E501

        :return: The suggested_labels of this LabelledTextSample.  # noqa: E501
        :rtype: str
        """
        return self._suggested_labels

    @suggested_labels.setter
    def suggested_labels(self, suggested_labels):
        """Sets the suggested_labels of this LabelledTextSample.

        The label suggested for the sample using the active learner  # noqa: E501

        :param suggested_labels: The suggested_labels of this LabelledTextSample.  # noqa: E501
        :type: str
        """

        self._suggested_labels = suggested_labels
