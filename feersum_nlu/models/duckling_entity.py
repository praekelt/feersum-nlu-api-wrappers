...
class DucklingEntity(object):
    ...
    attribute_map = {
        ...
        'to_value': 'to_value',
        'grain': 'grain',
        'from_grain': 'from_grain',
        'to_grain': 'to_grain',
        'unit': 'unit'
    }

    def __init__(self, body=None, dim=None, type=None, value=None, from_value=None, to_value=None, grain=None, from_grain=None, to_grain=None, unit=None):  # noqa: E501
        ...
        if grain is not None:
            self.grain = grain
        if from_grain is not None:
            self.from_grain = from_grain
        if to_grain is not None:
            self.to_grain = to_grain
        if unit is not None:
            self.unit = unit
    ...
    @property
    def from_value(self):
        """Gets the from_value of this DucklingEntity.  # noqa: E501

        Structured result value for an interval.  # noqa: E501

        :return: The from_value of this DucklingEntity.  # noqa: E501
        :rtype: str
        """
    ...
    def from_value(self, from_value):
        """Sets the from_value of this DucklingEntity.

        Structured result value for an interval.  # noqa: E501

        :param from_value: The from_value of this DucklingEntity.  # noqa: E501
        :type: str
        """
    ...
    @property
    def to_value(self):
        """Gets the to_value of this DucklingEntity.  # noqa: E501

        Structured result value for an interval.  # noqa: E501

        :return: The to_value of this DucklingEntity.  # noqa: E501
        :rtype: str
        """
    ...
    def to_value(self, to_value):
        """Sets the to_value of this DucklingEntity.

        Structured result value for an interval.  # noqa: E501

        :param to_value: The to_value of this DucklingEntity.  # noqa: E501
        :type: str
        """
    ...
    @property
    def from_grain(self):
        """Gets the from_grain of this DucklingEntity.  # noqa: E501

        The granularity/specificity of a time value for an interval.  # noqa: E501

        :return: The from_grain of this DucklingEntity.  # noqa: E501
        :rtype: str
        """
        return self._from_grain

    @from_grain.setter
    def from_grain(self, from_grain):
        """Sets the from_grain of this DucklingEntity.

        The granularity/specificity of a time value for an interval.  # noqa: E501

        :param from_grain: The from_grain of this DucklingEntity.  # noqa: E501
        :type: str
        """

        self._from_grain = from_grain

    @property
    def to_grain(self):
        """Gets the to_grain of this DucklingEntity.  # noqa: E501

        The granularity/specificity of a time value for an interval.  # noqa: E501

        :return: The to_grain of this DucklingEntity.  # noqa: E501
        :rtype: str
        """
        return self._to_grain

    @to_grain.setter
    def to_grain(self, to_grain):
        """Sets the to_grain of this DucklingEntity.

        The granularity/specificity of a time value for an interval.  # noqa: E501

        :param to_grain: The to_grain of this DucklingEntity.  # noqa: E501
        :type: str
        """

        self._to_grain = to_grain
