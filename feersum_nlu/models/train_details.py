...
class TrainDetails(object):
    ...
    def __init__(self, threshold=None, immediate_mode=None, word_manifold=None, word_manifold_list=None, clsfr_algorithm=None, language_model_list=None):  # noqa: E501
