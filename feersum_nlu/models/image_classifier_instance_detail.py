...
class ImageClassifierInstanceDetail(object):
    ...
    @property
    def cm_labels(self):
        """Gets the cm_labels of this ImageClassifierInstanceDetail.  # noqa: E501
        ...
        :return: The cm_labels of this ImageClassifierInstanceDetail.  # noqa: E501
        :rtype: object
        """
    ...
    def cm_labels(self, cm_labels):
        """Sets the cm_labels of this ImageClassifierInstanceDetail.

        A dict that, if present, maps from the confusion matrix row and column labels to longer more descriptive labels. For example, if present it maps an FAQ answer ID to the string answer which may be either a label or the full text answer.  # noqa: E501

        :param cm_labels: The cm_labels of this ImageClassifierInstanceDetail.  # noqa: E501
        :type: object
        """
