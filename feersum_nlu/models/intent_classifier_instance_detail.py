...
class IntentClassifierInstanceDetail(object):
    ...
    def training_sorted_cm_labels(self):
        """Gets the training_sorted_cm_labels of this IntentClassifierInstanceDetail.  # noqa: E501

        A list that, if present, proposes the order of the labels of the confusion matrix.  # noqa: E501

        :return: The training_sorted_cm_labels of this IntentClassifierInstanceDetail.  # noqa: E501
        :rtype: object
        """
    ...
    def training_sorted_cm_labels(self, training_sorted_cm_labels):
        """Sets the training_sorted_cm_labels of this IntentClassifierInstanceDetail.

        A list that, if present, proposes the order of the labels of the confusion matrix.  # noqa: E501

        :param training_sorted_cm_labels: The training_sorted_cm_labels of this IntentClassifierInstanceDetail.  # noqa: E501
        :type: object
        """
    ...
    def testing_sorted_cm_labels(self):
        """Gets the testing_sorted_cm_labels of this IntentClassifierInstanceDetail.  # noqa: E501

        A list that, if present, proposes the order of the labels of the confusion matrix.  # noqa: E501

        :return: The testing_sorted_cm_labels of this IntentClassifierInstanceDetail.  # noqa: E501
        :rtype: object
        """
    ...
    def testing_sorted_cm_labels(self, testing_sorted_cm_labels):
        """Sets the testing_sorted_cm_labels of this IntentClassifierInstanceDetail.

        A list that, if present, proposes the order of the labels of the confusion matrix.  # noqa: E501

        :param testing_sorted_cm_labels: The testing_sorted_cm_labels of this IntentClassifierInstanceDetail.  # noqa: E501
        :type: object
        """
