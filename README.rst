...
These language wrappers and examples are for version 2.0.1 of the HTTP API. The language wrappers are auto-generated from a Swagger spec of the API available at `<http://nlu.playground.feersum.io:443/nlu/v2/swagger.json>`_
...
`<http://nlu.playground.feersum.io:443/nlu/v2/ui/>`_
