...
from feersum_nlu.apis.regex_entity_extractors_api import RegexEntityExtractorsApi
...
class TestRegexEntityExtractorsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = feersum_nlu.apis.regex_entity_extractors_api.RegexEntityExtractorsApi()
